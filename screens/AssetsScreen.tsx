...
const AssetsScreen: React.FC<AssetsScreenProps> = ({ onBack, onNavigate }) => {
    ...
    <div className="bg-background-dark text-white font-display min-h-screen flex flex-col overflow-x-hidden animate-fade-in custom-scrollbar overflow-y-auto pb-10">
      ...
      {isLoading ? (
        ...
        <motion.main 
          ...
          initial="hidden"
          animate="show"
          className="flex-1 p-6 flex flex-col gap-10 pt-10"
        >
          {/* Portfolio Overview */}
          ...
          <motion.section variants={itemVariants} className="flex flex-col gap-4">
             ...
             <div className="p-8 bg-gradient-to-br from-indigo-900/40 to-surface-dark border border-indigo-500/20 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
