...
export const afriexClient = {
    ...
    getBankTransactions: async (type: 'local' | 'international') => {
        await new Promise(resolve => setTimeout(resolve, 600));
        if (type === 'local') {
            return [
                { id: 'btx1', recipient: 'Access Bank - Oluwa S.', amount: 25000, status: 'Completed', date: 'Today, 2:15 PM', reference: 'HP-LCL-89231' },
                { id: 'btx2', recipient: 'GTBank - Chidi E.', amount: 12000, status: 'Processing', date: 'Today, 9:45 AM', reference: 'HP-LCL-89232' },
                { id: 'btx3', recipient: 'Zenith - Amaka O.', amount: 50000, status: 'Completed', date: 'Yesterday', reference: 'HP-LCL-89230' }
            ];
        } else {
            return [
                { id: 'itx1', recipient: 'Barclays UK - James W.', amount: 500, currency: 'GBP', status: 'In Transit', date: 'Today, 11:00 AM', reference: 'HP-INT-44123' },
                { id: 'itx2', recipient: 'Chase US - Sarah L.', amount: 1200, currency: 'USD', status: 'Completed', date: 'Feb 14', reference: 'HP-INT-44120' },
                { id: 'itx3', recipient: 'Societe Generale - Marc A.', amount: 800, currency: 'EUR', status: 'Completed', date: 'Feb 12', reference: 'HP-INT-44118' }
            ];
        }
    }
};
